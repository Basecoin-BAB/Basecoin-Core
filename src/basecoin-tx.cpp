...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Basecoin Core basecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  basecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded basecoin transaction") + "\n" +
                               "  basecoin-tx [options] -create [commands]   " + _("Create hex-encoded basecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded basecoin transaction
