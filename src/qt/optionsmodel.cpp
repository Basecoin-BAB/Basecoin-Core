...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::BAB);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeBasecoinAmount"))
        SoftSetArg("-anonymizebasecoinamount", settings.value("nAnonymizeBasecoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in basecoin.cpp during shotdown to also remove the window positions
