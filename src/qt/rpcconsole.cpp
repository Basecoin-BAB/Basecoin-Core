                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBABPathCustom = GetArg("-zbabbackuppath", "");
    ...
    if(!strzBABPathCustom.empty()) {
        ui->wallet_customzbabbackuppath->setText(QString::fromStdString(strzBABPathCustom));
        ui->wallet_customzbabbackuppath_label->setVisible(true);
        ui->wallet_customzbabbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBABPathCustom.empty()) && nCustomBackupThreshold > 0) {
