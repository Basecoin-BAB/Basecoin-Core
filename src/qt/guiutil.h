...
/** Utility functions used by the Basecoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Basecoin addresses in monospace font
...
// Parse "basecoin:" URI into recipient object, return true on successful parsing
