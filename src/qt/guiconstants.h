...
/* Basecoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Basecoin"
#define QAPP_ORG_DOMAIN "basecoin.org"
#define QAPP_APP_NAME_DEFAULT "Basecoin-Qt"
#define QAPP_APP_NAME_TESTNET "Basecoin-Qt-testnet"
