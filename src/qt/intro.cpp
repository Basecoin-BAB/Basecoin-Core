...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Basecoin Core"),
     ...
     * override -datadir in the basecoin.conf file in the default data directory
     * (to be consistent with basecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
