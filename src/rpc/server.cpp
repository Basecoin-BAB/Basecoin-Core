...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Basecoin features */
        {"basecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"basecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"basecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"basecoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"basecoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"basecoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"basecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"basecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"basecoin", "startmasternode", &startmasternode, true, true, false},
        {"basecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"basecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"basecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"basecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"basecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"basecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"basecoin", "preparebudget", &preparebudget, true, true, false},
        {"basecoin", "submitbudget", &submitbudget, true, true, false},
        {"basecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"basecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"basecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"basecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"basecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"basecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"basecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"basecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"basecoin", "mnsync", &mnsync, true, true, false},
        {"basecoin", "spork", &spork, true, true, false},
        {"basecoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbabseed", &getzbabseed, false, false, true},
        {"zerocoin", "setzbabseed", &setzbabseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbab", &searchdzbab, false, false, true},
        {"zerocoin", "dzbabstate", &dzbabstate, false, false, true},
...
{
    return "> basecoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22631/\n";
}
