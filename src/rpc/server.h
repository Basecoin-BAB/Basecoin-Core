...
/**
 * Basecoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZbabSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzbabseed(const UniValue& params, bool fHelp);
extern UniValue getzbabseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbab(const UniValue& params, bool fHelp);
extern UniValue dzbabstate(const UniValue& params, bool fHelp);
