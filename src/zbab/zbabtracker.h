...
#ifndef Basecoin_ZBABTRACKER_H
#define Basecoin_ZBABTRACKER_H
...
public:
    CzBABTracker(std::string strWalletFile);
    ~CzBABTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBABWallet* zBABWallet = NULL);
