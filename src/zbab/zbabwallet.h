...
#ifndef Basecoin_ZBABWALLET_H
#define Basecoin_ZBABWALLET_H
...
public:
    CzBABWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBAB(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBAB(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
