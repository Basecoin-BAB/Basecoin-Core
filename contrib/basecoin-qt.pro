...
RESOURCES += src/qt/basecoin.qrc src/qt/basecoin_locale.qrc

TRANSLATIONS += src/qt/locale/basecoin_bg.ts \
                src/qt/locale/basecoin_de.ts \
                src/qt/locale/basecoin_en.ts \
                src/qt/locale/basecoin_es.ts \
                src/qt/locale/basecoin_fi.ts \
                src/qt/locale/basecoin_fr.ts \
                src/qt/locale/basecoin_it.ts \
                src/qt/locale/basecoin_ja.ts \
                src/qt/locale/basecoin_pl.ts \
                src/qt/locale/basecoin_pt.ts \
                src/qt/locale/basecoin_ru.ts \
                src/qt/locale/basecoin_sk.ts \
                src/qt/locale/basecoin_sv.ts \
                src/qt/locale/basecoin_vi.ts \
                src/qt/locale/basecoin_zh_CN.ts \
                src/qt/locale/basecoin_zh_TW.ts
