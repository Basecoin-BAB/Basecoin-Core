Contributing to Basecoin Core
============================

The Basecoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/basecoin-project/basecoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Basecoin Core project, and is not to be
confused with overall Basecoin Network Protocol consensus changes.

Whether a pull request is merged into Basecoin Core rests with the project merge
...
Patches that change Basecoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Basecoin consensus, it must have been
...
The project leader is the release manager for each Basecoin Core release.
