...
from fake_stake.base_test import Basecoin_FakeStakeTest

class zBABwrappedSerialsTest(Basecoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBABs..." % DENOM_TO_USE)
